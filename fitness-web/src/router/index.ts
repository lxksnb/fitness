  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'admin/templates/create', name: 'AdminTemplateCreate', component: () => import('@/views/admin/AdminTemplateEditor.vue'), meta: { admin: true } },
        { path: 'admin/templates/:id/edit', name: 'AdminTemplateEdit', component: () => import('@/views/admin/AdminTemplateEditor.vue'), meta: { admin: true } },
