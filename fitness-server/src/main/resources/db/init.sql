...
('SYSTEM', NULL, '杠铃卧推',
 ...
 'CHEST,ARMS,SHOULDER',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-bench-press.svg'),
 NULL),

('SYSTEM', NULL, '上斜杠铃卧推',
 '主要刺激上胸，凳子角度建议30~45度。',
 'CHEST,SHOULDER,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/incline-barbell-bench-press.svg'),
 NULL),

('SYSTEM', NULL, '下斜杠铃卧推',
 '强化下胸区域，同时减少肩部参与。',
 'CHEST,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/decline-barbell-bench-press.svg'),
 NULL),

('SYSTEM', NULL, '哑铃卧推',
 '比杠铃拥有更大活动范围，可改善左右肌力不平衡。',
 'CHEST,ARMS,SHOULDER',
 JSON_ARRAY('/uploads/2026/05/27/actions/dumbbell-bench-press.svg'),
 NULL),

('SYSTEM', NULL, '上斜哑铃卧推',
 '重点刺激上胸和肩前束。',
 'CHEST,SHOULDER',
 JSON_ARRAY('/uploads/2026/05/27/actions/incline-dumbbell-bench-press.svg'),
 NULL),

('SYSTEM', NULL, '双杠臂屈伸',
 '身体前倾时重点刺激下胸，同时训练肱三头。',
 'CHEST,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/parallel-bar-dips.svg'),
 NULL),

('SYSTEM', NULL, '绳索夹胸',
 '孤立胸肌，顶峰收缩明显。',
 'CHEST',
 JSON_ARRAY('/uploads/2026/05/27/actions/cable-fly.svg'),
 NULL),

('SYSTEM', NULL, '蝴蝶机夹胸',
 '器械孤立胸部动作，适合新手建立胸肌发力感。',
 'CHEST',
 JSON_ARRAY('/uploads/2026/05/27/actions/pec-deck-fly.svg'),
 NULL),

('SYSTEM', NULL, '俯卧撑',
 '经典自重推类动作，适合作为热身和耐力训练。',
 'CHEST,ARMS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/push-up.svg'),
 NULL),
...
('SYSTEM', NULL, '引体向上',
 '经典背部自重动作，主要刺激背阔肌。',
 'BACK,ARMS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/pull-up.svg'),
 NULL),

('SYSTEM', NULL, '高位下拉',
 '适合替代引体向上，主要刺激背阔肌。',
 'BACK,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/lat-pulldown.svg'),
 NULL),

('SYSTEM', NULL, '杠铃划船',
 '经典背部厚度训练动作，强化上背与背阔。',
 'BACK,ARMS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-row.svg'),
 NULL),

('SYSTEM', NULL, '哑铃单臂划船',
 '改善左右背部发力差异，强化背阔肌。',
 'BACK,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/one-arm-dumbbell-row.svg'),
 NULL),

('SYSTEM', NULL, '坐姿划船',
 '稳定性高，适合中下背训练。',
 'BACK,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/seated-cable-row.svg'),
 NULL),

('SYSTEM', NULL, 'T杠划船',
 '强化背部厚度和斜方肌。',
 'BACK,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/t-bar-row.svg'),
 NULL),

('SYSTEM', NULL, '硬拉',
 '经典全身复合动作，强化后链。',
 'BACK,LEGS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/deadlift.svg'),
 NULL),

('SYSTEM', NULL, '罗马尼亚硬拉',
 '重点刺激腘绳肌和臀部。',
 'LEGS,BACK,GLUTES',
 JSON_ARRAY('/uploads/2026/05/27/actions/romanian-deadlift.svg'),
 NULL),

('SYSTEM', NULL, '面拉',
 '强化肩后束与上背，改善圆肩。',
 'BACK,SHOULDER',
 JSON_ARRAY('/uploads/2026/05/27/actions/face-pull.svg'),
 NULL),
...
('SYSTEM', NULL, '杠铃肩推',
 '肩部经典推举动作，主要刺激肩前束。',
 'SHOULDER,ARMS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-shoulder-press.svg'),
 NULL),

('SYSTEM', NULL, '哑铃肩推',
 '提升肩部稳定性与活动范围。',
 'SHOULDER,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/dumbbell-shoulder-press.svg'),
 NULL),

('SYSTEM', NULL, '阿诺德推举',
 '旋转轨迹增加肩部刺激。',
 'SHOULDER,ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/arnold-press.svg'),
 NULL),

('SYSTEM', NULL, '哑铃侧平举',
 '经典肩中束孤立动作。',
 'SHOULDER',
 JSON_ARRAY('/uploads/2026/05/27/actions/lateral-raise.svg'),
 NULL),

('SYSTEM', NULL, '俯身飞鸟',
 '主要刺激肩后束。',
 'SHOULDER,BACK',
 JSON_ARRAY('/uploads/2026/05/27/actions/bent-over-fly.svg'),
 NULL),

('SYSTEM', NULL, '杠铃耸肩',
 '强化斜方肌。',
 'SHOULDER,BACK',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-shrug.svg'),
 NULL),
...
('SYSTEM', NULL, '杠铃弯举',
 '经典肱二头训练动作。',
 'ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-curl.svg'),
 NULL),

('SYSTEM', NULL, '哑铃弯举',
 '增强肱二头峰值收缩。',
 'ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/dumbbell-curl.svg'),
 NULL),

('SYSTEM', NULL, '锤式弯举',
 '重点刺激肱肌与前臂。',
 'ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/hammer-curl.svg'),
 NULL),

('SYSTEM', NULL, '绳索下压',
 '经典肱三头孤立动作。',
 'ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/cable-pushdown.svg'),
 NULL),

('SYSTEM', NULL, '仰卧臂屈伸',
 '重点刺激肱三头长头。',
 'ARMS',
 JSON_ARRAY('/uploads/2026/05/27/actions/lying-triceps-extension.svg'),
 NULL),

('SYSTEM', NULL, '窄距卧推',
 '复合型肱三头训练动作。',
 'ARMS,CHEST',
 JSON_ARRAY('/uploads/2026/05/27/actions/close-grip-bench-press.svg'),
 NULL),
...
('SYSTEM', NULL, '杠铃深蹲',
 '下肢训练之王，强化股四头、臀部和核心。',
 'LEGS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/barbell-squat.svg'),
 NULL),

('SYSTEM', NULL, '前蹲',
 '更偏向股四头刺激。',
 'LEGS,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/front-squat.svg'),
 NULL),

('SYSTEM', NULL, '保加利亚分腿蹲',
 '单腿训练，提高稳定性和平衡。',
 'LEGS,GLUTES,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/bulgarian-split-squat.svg'),
 NULL),

('SYSTEM', NULL, '腿举',
 '器械腿部复合动作。',
 'LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/leg-press.svg'),
 NULL),

('SYSTEM', NULL, '腿屈伸',
 '孤立股四头肌。',
 'LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/leg-extension.svg'),
 NULL),

('SYSTEM', NULL, '腿弯举',
 '孤立腘绳肌。',
 'LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/leg-curl.svg'),
 NULL),

('SYSTEM', NULL, '臀桥',
 '重点刺激臀大肌。',
 'GLUTES,CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/glute-bridge.svg'),
 NULL),

('SYSTEM', NULL, '坐姿提踵',
 '孤立小腿训练。',
 'LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/seated-calf-raise.svg'),
 NULL),

('SYSTEM', NULL, '站姿提踵',
 '强化腓肠肌。',
 'LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/standing-calf-raise.svg'),
 NULL),
...
('SYSTEM', NULL, '卷腹',
 '经典腹直肌训练动作。',
 'CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/crunch.svg'),
 NULL),

('SYSTEM', NULL, '平板支撑',
 '核心稳定训练动作。',
 'CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/plank.svg'),
 NULL),

('SYSTEM', NULL, '俄罗斯转体',
 '强化腹斜肌。',
 'CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/russian-twist.svg'),
 NULL),

('SYSTEM', NULL, '悬垂举腿',
 '强化下腹与髋屈肌。',
 'CORE',
 JSON_ARRAY('/uploads/2026/05/27/actions/hanging-leg-raise.svg'),
 NULL),
...
('SYSTEM', NULL, '跑步机跑步',
 '经典有氧训练。',
 'CARDIO',
 JSON_ARRAY('/uploads/2026/05/27/actions/treadmill-run.svg'),
 NULL),

('SYSTEM', NULL, '椭圆机',
 '低冲击有氧训练。',
 'CARDIO',
 JSON_ARRAY('/uploads/2026/05/27/actions/elliptical.svg'),
 NULL),

('SYSTEM', NULL, '划船机',
 '结合有氧与背部发力。',
 'CARDIO,BACK',
 JSON_ARRAY('/uploads/2026/05/27/actions/rowing-machine.svg'),
 NULL),

('SYSTEM', NULL, '波比跳',
 '高强度全身有氧动作。',
 'CARDIO,CORE,LEGS',
 JSON_ARRAY('/uploads/2026/05/27/actions/burpee.svg'),
 NULL);
...
-- 主食
('SYSTEM', NULL, '生大米', 'STAPLE', '/uploads/2026/05/27/foods/raw-rice.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '熟米饭', 'STAPLE', '/uploads/2026/05/27/foods/cooked-rice.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '糙米饭', 'STAPLE', '/uploads/2026/05/27/foods/brown-rice.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炒饭', 'STAPLE', '/uploads/2026/05/27/foods/fried-rice.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '白面条(生)', 'STAPLE', '/uploads/2026/05/27/foods/raw-noodles.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '煮面条', 'STAPLE', '/uploads/2026/05/27/foods/cooked-noodles.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炒面', 'STAPLE', '/uploads/2026/05/27/foods/fried-noodles.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '全麦面包', 'STAPLE', '/uploads/2026/05/27/foods/whole-wheat-bread.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '白面包', 'STAPLE', '/uploads/2026/05/27/foods/white-bread.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '燕麦片', 'STAPLE', '/uploads/2026/05/27/foods/oats.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '红薯(生)', 'STAPLE', '/uploads/2026/05/27/foods/raw-sweet-potato.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '蒸红薯', 'STAPLE', '/uploads/2026/05/27/foods/steamed-sweet-potato.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '玉米', 'STAPLE', '/uploads/2026/05/27/foods/corn.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '土豆(生)', 'STAPLE', '/uploads/2026/05/27/foods/raw-potato.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '水煮土豆', 'STAPLE', '/uploads/2026/05/27/foods/boiled-potato.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炸薯条', 'STAPLE', '/uploads/2026/05/27/foods/french-fries.svg', 'ACTIVE', NULL),

-- 牛肉
('SYSTEM', NULL, '生牛肉', 'MEAT', '/uploads/2026/05/27/foods/raw-beef.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '牛排(煎)', 'MEAT', '/uploads/2026/05/27/foods/steak.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '卤牛肉', 'MEAT', '/uploads/2026/05/27/foods/braised-beef.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炒牛肉', 'MEAT', '/uploads/2026/05/27/foods/stir-fried-beef.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炖牛肉', 'MEAT', '/uploads/2026/05/27/foods/stewed-beef.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '肥牛卷', 'MEAT', '/uploads/2026/05/27/foods/beef-rolls.svg', 'ACTIVE', NULL),

-- 猪肉
('SYSTEM', NULL, '瘦猪肉(生)', 'MEAT', '/uploads/2026/05/27/foods/lean-pork-raw.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '五花肉', 'MEAT', '/uploads/2026/05/27/foods/pork-belly.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '红烧肉', 'MEAT', '/uploads/2026/05/27/foods/braised-pork-belly.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '猪里脊', 'MEAT', '/uploads/2026/05/27/foods/pork-tenderloin.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炒肉丝', 'MEAT', '/uploads/2026/05/27/foods/stir-fried-shredded-pork.svg', 'ACTIVE', NULL),

-- 鸡肉
('SYSTEM', NULL, '鸡胸肉(生)', 'MEAT', '/uploads/2026/05/27/foods/raw-chicken-breast.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '水煮鸡胸肉', 'MEAT', '/uploads/2026/05/27/foods/boiled-chicken-breast.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '煎鸡胸肉', 'MEAT', '/uploads/2026/05/27/foods/pan-fried-chicken-breast.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '炸鸡', 'MEAT', '/uploads/2026/05/27/foods/fried-chicken.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '鸡腿肉', 'MEAT', '/uploads/2026/05/27/foods/chicken-thigh.svg', 'ACTIVE', NULL),

-- 羊肉
('SYSTEM', NULL, '生羊肉', 'MEAT', '/uploads/2026/05/27/foods/raw-lamb.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '涮羊肉', 'MEAT', '/uploads/2026/05/27/foods/hotpot-lamb.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '烤羊肉串', 'MEAT', '/uploads/2026/05/27/foods/lamb-skewers.svg', 'ACTIVE', NULL),

-- 鱼虾海鲜
('SYSTEM', NULL, '三文鱼', 'SEAFOOD', '/uploads/2026/05/27/foods/salmon.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '金枪鱼', 'SEAFOOD', '/uploads/2026/05/27/foods/tuna.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '鳕鱼', 'SEAFOOD', '/uploads/2026/05/27/foods/cod.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '虾仁', 'SEAFOOD', '/uploads/2026/05/27/foods/shrimp.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '煎鱼', 'SEAFOOD', '/uploads/2026/05/27/foods/pan-fried-fish.svg', 'ACTIVE', NULL),

-- 蛋奶豆制品
('SYSTEM', NULL, '鸡蛋', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/egg.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '蛋清', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/egg-white.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '全脂牛奶', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/whole-milk.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '低脂牛奶', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/low-fat-milk.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '无糖酸奶', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/plain-yogurt.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '北豆腐', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/tofu.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '豆浆', 'EGG_DAIRY_SOY', '/uploads/2026/05/27/foods/soy-milk.svg', 'ACTIVE', NULL),

-- 水果
('SYSTEM', NULL, '苹果', 'FRUIT', '/uploads/2026/05/27/foods/apple.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '香蕉', 'FRUIT', '/uploads/2026/05/27/foods/banana.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '橙子', 'FRUIT', '/uploads/2026/05/27/foods/orange.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '草莓', 'FRUIT', '/uploads/2026/05/27/foods/strawberry.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '蓝莓', 'FRUIT', '/uploads/2026/05/27/foods/blueberry.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '西瓜', 'FRUIT', '/uploads/2026/05/27/foods/watermelon.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '牛油果', 'FRUIT', '/uploads/2026/05/27/foods/avocado.svg', 'ACTIVE', NULL),

-- 蔬菜
('SYSTEM', NULL, '西兰花', 'VEGETABLE', '/uploads/2026/05/27/foods/broccoli.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '菠菜', 'VEGETABLE', '/uploads/2026/05/27/foods/spinach.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '黄瓜', 'VEGETABLE', '/uploads/2026/05/27/foods/cucumber.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '番茄', 'VEGETABLE', '/uploads/2026/05/27/foods/tomato.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '胡萝卜', 'VEGETABLE', '/uploads/2026/05/27/foods/carrot.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '生菜', 'VEGETABLE', '/uploads/2026/05/27/foods/lettuce.svg', 'ACTIVE', NULL),

-- 坚果
('SYSTEM', NULL, '杏仁', 'NUT', '/uploads/2026/05/27/foods/almond.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '腰果', 'NUT', '/uploads/2026/05/27/foods/cashew.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '花生', 'NUT', '/uploads/2026/05/27/foods/peanut.svg', 'ACTIVE', NULL),

-- 饮品/其他
('SYSTEM', NULL, '乳清蛋白粉', 'NUT', '/uploads/2026/05/27/foods/whey-protein.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '可乐', 'NUT', '/uploads/2026/05/27/foods/cola.svg', 'ACTIVE', NULL),
('SYSTEM', NULL, '无糖可乐', 'NUT', '/uploads/2026/05/27/foods/diet-cola.svg', 'ACTIVE', NULL);
